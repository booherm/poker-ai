...
Ext.define('Ext.ux.TabScrollerMenu', {
	 ...
	 * Using a value of zero will disable submenus, placing all items in the primary menu.
     */
    pageSize: 10,
    /**
    ...
    generateTabMenuItems: function() {
        ...
        numSubMenus = (pageSize === 0) ? 0 : Math.floor(totalItems / pageSize);
        remainder = (pageSize === 0) ? totalItems : totalItems % pageSize;
