...
DROP TABLE strategy_variable;
DROP TABLE strategy_expression_map;
...
@C:\projects\vs_workspace\poker_ai\poker_ai\db\table\strategy_expression_map.sql;
@C:\projects\vs_workspace\poker_ai\poker_ai\db\table\strategy_variable.sql;
